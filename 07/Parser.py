...
class Parser:
    ...
    def command_type(self) -> str:
        ...
        if current_line.startswith("push"):
            return "C_PUSH"
        elif current_line.startswith("pop"):
            return "C_POP"
        elif current_line.startswith("("):
            return "C_LABEL"
        elif current_line.startswith("goto"):
            return "C_GOTO"
        elif current_line.startswith("if"):
            return "C_IF"
        elif current_line.startswith("function"):
            return "C_FUNCTION"
        elif current_line.startswith("return"):
            return "C_RETURN"
        elif current_line.startswith("call"):
            return "C_CALL"
        return "C_ARITHMETIC"
    ...
    def arg1(self) -> str:
        ...
        """
        current_line = self.__input_lines[self.__current_line]
    ...
    def arg2(self) -> int:
        ...
        """
        return int(self.__input_lines[self.__current_line].split()[2])
    
    def current_line(self) -> str:
        """
        Returns:
        str: current line as a string
        """
        return self.__input_lines[self.__current_line]
